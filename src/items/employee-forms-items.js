...
export const formCreateItems = [
  { key: 'hggt77g7ygy', name: 'name', label: 'Имя', rules: validateName, icon: <UserOutlined />, placeholder: 'Введите имя' },
  {
    key: 'sadhsahd27',
    name: 'surname',
    label: 'Фамилия',
  ...
  { key: 'jkeuun872', name: 'email', label: 'Email', rules: validateEmail, icon: <MailOutlined />, placeholder: 'example@gmail.com' },
  {
    key: 'jsduisj89',
